...
<head>
  ...
  <link rel="stylesheet" href="{prefix}css/styles.css?v=6">
  <link rel="stylesheet" href="{prefix}css/pages.css?v=6">
</head>
<body class="{body_cls}">
...
{HEADER_SOCIAL}
  ...
  <script src="{prefix}js/main.js?v=6"></script>
</body>
</html>"""
